...
python discovery_child_development/pipeline/models/binary_classifier/05_inference_evals.py
...
if __name__ == "__main__":
    ...
    data_for_labelling = (
        pd.DataFrame(load_jsonl(LABELS_RELEVANCE))
    ...
    S3.upload_obj(
        predictions,
        S3_BUCKET,
        f"data/outputs/binary_classifier/openalex_patents_relevance_labels_truth.csv",
    )
