...
PATH_TO_DATASET = (
    ENRICHED_DATA_DIR / "patents_relevance_labels_only_relevant.csv"
)

# Path to sentence embeddings
VECTORS_PATH = "data/outputs/vectors/"
VECTORS_FILE = "sentence_vectors_patents_384_labelled.parquet"
...
if __name__ == "__main__":
    ...
    for topic in topics:
        ...
        (
            ...
            .to_csv(
                ENRICHED_DATA_DIR
                / f"taxonomy_cat/patents/taxonomy_cat_predictions_{topic}.csv",
                index=False,
            )
        )
