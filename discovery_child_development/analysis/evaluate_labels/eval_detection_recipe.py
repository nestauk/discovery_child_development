"""
Recipe for evaluating detection management labels

```
python -m prodigy eval_labels test_data outputs/labels/evals_data/detection_management_labels_eval.jsonl -F discovery_child_development/analysis/evaluate_labels/eval_detection_recipe.py
```
or
```
python -m prodigy eval_labels detection_data outputs/labels/evals_data/detection_management_labels_eval.jsonl -F discovery_child_development/analysis/evaluate_labels/eval_detection_recipe.py
```

To export the data and have it saved locally, run:
```
prodigy db-out detection_data > outputs/labels/evals_data/detection_labels_eval_annotated.jsonl
```
...
def eval_labels(dataset: str, source: str):
    ...
    options = ["Detection", "Management", "Both", "None", "???"]
    ...
    return {
        ...
        "stream": stream,
        "config": {
            "instructions": "discovery_child_development/analysis/evaluate_labels/eval_detection_instructions.html",
